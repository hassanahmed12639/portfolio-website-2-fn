    ...
    <>
      <button
        ...
        className={cn(
          ...
          'bg-[#2563eb] text-white hover:bg-[#1d4ed8] focus:outline-none focus:ring-2 focus:ring-[#2563eb] focus:ring-offset-2'
        )}
        ...
        >
          ...
          <div className="flex h-80 flex-col overflow-hidden">
            <div className="flex-1 overflow-y-auto p-4 space-y-3">
              ...
              {error && (
                <p className="text-xs text-[#2563eb]">{error}</p>
              )}
            ...
            <form onSubmit={handleSubmit} className="border-t border-gray-200 p-3">
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className={cn(
'rounded-lg bg-[#2563eb] px-4 py-2 text-sm font-medium text-white',
    'hover:bg-[#1d4ed8] hover:shadow-[0_0_20px_rgba(37,99,235,0.35)] focus:outline-none focus:ring-2 focus:ring-[#2563eb] focus:ring-offset-2',
