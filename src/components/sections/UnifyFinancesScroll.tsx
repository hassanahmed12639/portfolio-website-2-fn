        ...
        <div className="relative w-full h-full pointer-events-none z-10" style={{ overflow: "hidden" }}>
          {[0, 1, 2, 3, 4].map((i) => (
            <div
              ...
              className="absolute left-1/2 top-1/2 w-[120px] h-[115px] xs:w-[150px] xs:h-[143px] sm:w-[180px] sm:h-[172px] md:w-[200px] md:h-[191px] lg:w-[240px] lg:h-[230px] xl:w-[280px] xl:h-[268px] 2xl:w-[320px] 2xl:h-[306px] rounded-2xl sm:rounded-3xl bg-white"
              style={{
