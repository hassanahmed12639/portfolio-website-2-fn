...
export default function AnimatedCardsSection() {
  ...
  return (
    <section className="w-full bg-white pt-0 pb-12 md:pt-0 md:pb-16 lg:pt-0 lg:pb-20 xl:pt-0 xl:pb-24 2xl:pt-0 2xl:pb-32">
      <div className="flex flex-col items-center justify-center gap-6 sm:gap-8 md:gap-10 lg:gap-12 xl:gap-14 w-full max-w-[95%] xs:max-w-[90%] sm:max-w-5xl md:max-w-6xl lg:max-w-7xl xl:max-w-[1400px] 2xl:max-w-[1600px] px-3 xs:px-4 sm:px-5 md:px-8 lg:px-12 xl:px-16 mx-auto">
        ...
        <div className="text-center mb-8 md:mb-12">
          ...
          <p className="text-base md:text-lg text-gray-600 max-w-2xl mx-auto">
            Discover the powerful tools and features that help you build amazing products and scale your business.
          </p>
        </div>
