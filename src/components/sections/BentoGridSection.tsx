            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between py-2 px-3 bg-gray-50 rounded-lg">
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <TrendingUp className="w-3.5 h-3.5 text-[#AAFF00]" />
                </div>
              </div>
              <div className="flex items-center justify-between py-2 px-3 bg-gray-50 rounded-lg">
              ...
              <div className="flex items-center justify-between py-2 px-3 bg-gray-50 rounded-lg">
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <Activity className="w-3.5 h-3.5 text-[#AAFF00]" />
                </div>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="absolute bottom-0 left-0 right-0 p-4">
              <div className="flex items-center gap-2 mb-1">
                ...
                <div className="w-5 h-5 bg-[#AAFF00] rounded-full flex items-center justify-center">
          ...
          <div className="lg:col-span-7 lg:row-start-3 grid grid-cols-2 gap-6">
            ...
            >
              <div className="flex items-center justify-between mb-3">
                ...
                <span className="text-xs text-[#AAFF00] font-medium">+4</span>
              </div>
            ...
            >
              <div className="flex items-center justify-between mb-3">
                ...
                <span className="text-xs text-[#AAFF00] font-medium">+12</span>
              </div>
              <div className="flex -space-x-2">
