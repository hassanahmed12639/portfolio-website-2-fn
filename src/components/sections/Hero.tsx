      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 items-start gap-10 lg:grid-cols-12 lg:gap-12">
          ...
          <div className="flex flex-col justify-center lg:col-span-7">
            ...
            <h1 className="mt-5 text-left text-3xl font-bold leading-tight tracking-tight text-textPrimary sm:mt-6 sm:text-4xl md:text-[2.75rem] lg:text-5xl xl:text-[3.25rem]">
              Welcome to the
              <br />
          ...
          <div className="relative lg:col-span-5">
            <div className="grid grid-cols-1 gap-3 sm:gap-4 md:grid-cols-[1fr_minmax(0,200px)] md:grid-rows-[auto_auto_auto]">
              <div className="row-span-2 overflow-hidden rounded-2xl bg-[#393E41]/5 shadow-[0_8px_30px_rgba(0,0,0,0.08)] md:min-h-0">
              ...
              <div className="flex flex-col justify-center rounded-2xl bg-white p-4 shadow-[0_8px_30px_rgba(0,0,0,0.08)] sm:p-5 md:col-start-2 md:row-start-1">
                <span className="text-2xl font-bold text-textPrimary sm:text-3xl">$14B</span>
                <span className="mt-0.5 text-sm text-textPrimary/80 sm:text-base">Funds & Syndicates</span>
              </div>

              <div className="flex flex-col justify-center rounded-2xl bg-designBg p-4 shadow-[0_8px_30px_rgba(0,0,0,0.08)] sm:p-5 md:col-start-2 md:row-start-2">
                <span className="text-2xl font-bold text-textPrimary sm:text-3xl">80k</span>
                <span className="mt-0.5 text-sm text-textPrimary/80 sm:text-base">Active members</span>
                <div className="mt-2 flex -space-x-2">
                  {AVATAR_COLORS.map((bg, i) => (
                    <div
                      key={i}
                      className={`h-6 w-6 rounded-full border-2 border-designBg ${bg}`}
                      aria-hidden
                    />
                  ))}
                </div>
              ...
              <div className="rounded-2xl bg-white p-4 shadow-[0_8px_30px_rgba(0,0,0,0.08)] sm:p-5 md:col-start-1 md:row-start-3">
                <span className="text-2xl font-bold text-textPrimary sm:text-3xl">27k+</span>
                <span className="mt-0.5 block text-sm text-textPrimary/80 sm:text-base">Raised by startups</span>
              </div>
            </div>
          </div>
        </div>
