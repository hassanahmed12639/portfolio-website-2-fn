  ...
  return (
    <>
      ...
      <motion.div
        ...
        className={cn(
          "p-3 flex flex-col justify-between items-stretch bg-zinc-50 shadow-md dark:shadow-none dark:bg-zinc-950 rounded-2xl cursor-pointer border border-gray-200/70 dark:border-zinc-900",
          className,
        )}
      >
        <div className="flex gap-4 flex-col flex-1 min-w-0">
          <motion.div layoutId={`image-${title}-${id}`} className="overflow-hidden rounded-xl w-full flex-shrink-0">
            <img
              src={src}
              alt={title}
          ...
          <div className="flex justify-between items-start gap-3 w-full">
            <div className="flex flex-col min-w-0 text-left">
              ...
              <motion.h3
                layoutId={`title-${title}-${id}`}
                className="text-black dark:text-white font-semibold text-base mt-0.5"
              >
                {title}
              </motion.h3>
            </div>
