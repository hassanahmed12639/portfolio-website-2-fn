  ...
  return (
    <div className="p-6 md:p-8 max-w-4xl">
      ...
      <section className="mb-10">
        ...
        <div className="rounded-xl border border-[var(--dash-border)] bg-[var(--dash-surface)]/50 p-5 space-y-6">
          <div>
      ...
      <section className="mb-8">
        ...
        <div className="space-y-2">
          {[
            ...
            <div key={id} className="rounded-xl border border-[var(--dash-border)] bg-[var(--dash-surface)]/50 overflow-hidden">
              <button
                type="button"
